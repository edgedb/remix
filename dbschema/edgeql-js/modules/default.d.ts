...
export declare type $NoteλShape = $.typeutil.flatten<_std.$Object_1314de600e2e11ed9ceb0977e08fb96bλShape & {
...
export declare type $PasswordλShape = $.typeutil.flatten<_std.$Object_1314de600e2e11ed9ceb0977e08fb96bλShape & {
...
export declare type $UserλShape = $.typeutil.flatten<_std.$Object_1314de600e2e11ed9ceb0977e08fb96bλShape & {
  "createdAt": $.PropertyDesc<_std.$datetime, $.Cardinality.One, false, false, false, true>;
