...
export declare type $Object_137270700e2e11ed93dedb53acd9287bλShape = $.typeutil.flatten<_std.$BaseObjectλShape & {
...
declare type $Object_137270700e2e11ed93dedb53acd9287b = $.ObjectType<"schema::Object", $Object_137270700e2e11ed93dedb53acd9287bλShape, null>;
declare const $Object_137270700e2e11ed93dedb53acd9287b: $Object_137270700e2e11ed93dedb53acd9287b

declare const Object_137270700e2e11ed93dedb53acd9287b: $.$expr_PathNode<$.TypeSet<$Object_137270700e2e11ed93dedb53acd9287b, $.Cardinality.Many>, null, true> 

export declare type $SubclassableObjectλShape = $.typeutil.flatten<$Object_137270700e2e11ed93dedb53acd9287bλShape & {
...
export declare type $AnnotationSubjectλShape = $.typeutil.flatten<$Object_137270700e2e11ed93dedb53acd9287bλShape & {
...
export declare type $VolatilitySubjectλShape = $.typeutil.flatten<$Object_137270700e2e11ed93dedb53acd9287bλShape & {
...
export declare type $ConsistencySubjectλShape = $.typeutil.flatten<$Object_137270700e2e11ed93dedb53acd9287bλShape & $InheritingObjectλShape & $AnnotationSubjectλShape & {
...
export declare type $DeltaλShape = $.typeutil.flatten<$Object_137270700e2e11ed93dedb53acd9287bλShape & {
...
export declare type $ExtensionλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_137270700e2e11ed93dedb53acd9287bλShape & {
...
export declare type $SourceλShape = $.typeutil.flatten<$Object_137270700e2e11ed93dedb53acd9287bλShape & {
...
export declare type $MigrationλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_137270700e2e11ed93dedb53acd9287bλShape & {
...
export declare type $ModuleλShape = $.typeutil.flatten<$Object_137270700e2e11ed93dedb53acd9287bλShape & $AnnotationSubjectλShape & {
}>;
...
export declare type $ParameterλShape = $.typeutil.flatten<$Object_137270700e2e11ed93dedb53acd9287bλShape & {
  "type": $.LinkDesc<$Type, $.Cardinality.One, {}, false, false,  false, false>;
