...
const JsonEmpty = $.makeType(_.spec, "11ec421c-0e2e-11ed-a2cb-0b097a4898b4", _.syntax.literal);
...
const $sequence = $.makeType(_.spec, "0dcbec50-0e2e-11ed-9aa4-b5275a3bf581", _.syntax.literal);
...
const $BaseObject = $.makeType(_.spec, "1310ab9c-0e2e-11ed-a2b9-b1f9d3e61ac9", _.syntax.literal);

const BaseObject= _.syntax.$PathNode($.$toSet($BaseObject, $.Cardinality.Many), null, true);

const $Object_1314de600e2e11ed9ceb0977e08fb96b = $.makeType(_.spec, "1314de60-0e2e-11ed-9ceb-0977e08fb96b", _.syntax.literal);

const Object_1314de600e2e11ed9ceb0977e08fb96b= _.syntax.$PathNode($.$toSet($Object_1314de600e2e11ed9ceb0977e08fb96b, $.Cardinality.Many), null, true);

const $FreeObject = $.makeType(_.spec, "1319b0c0-0e2e-11ed-bc68-19d7456e1847", _.syntax.literal);
...
Object.assign(exports, { $JsonEmptyλEnum: $JsonEmptyλEnum, JsonEmpty: JsonEmpty, bigint: bigint, bool: bool, bytes: bytes, datetime: datetime, decimal: decimal, duration: duration, float32: float32, float64: float64, int16: int16, int32: int32, int64: int64, json: json, $sequence: $sequence, str: str, uuid: uuid, number: number, $BaseObject: $BaseObject, BaseObject: BaseObject, $Object_1314de600e2e11ed9ceb0977e08fb96b: $Object_1314de600e2e11ed9ceb0977e08fb96b, Object_1314de600e2e11ed9ceb0977e08fb96b: Object_1314de600e2e11ed9ceb0977e08fb96b, $FreeObject: $FreeObject, FreeObject: FreeObject });
