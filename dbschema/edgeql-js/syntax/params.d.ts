...
import { Expression, ExpressionKind, ParamType, Cardinality, setToTsType, TypeSet, unwrapCastableType, BaseTypeToTsType } from "edgedb/dist/reflection";
...
declare type paramsToParamArgs<Params extends {
    ...
    [key in keyof Params as Params[key] extends ParamType ? key : never]: Params[key] extends ParamType ? BaseTypeToTsType<Params[key]> : never;
} & {
    [key in keyof Params as Params[key] extends $expr_OptionalParam ? key : never]?: Params[key] extends $expr_OptionalParam ? BaseTypeToTsType<Params[key]["__type__"]> | null : never;
};
