    ...
    get(target, prop, proxy) {
        ...
        if (match) {
            ...
            return (0, path_1.$expressionify)({
                ...
                __element__: target.__element__.__kind__ === reflection_1.TypeKind.array && isIndex
...
function arrayLikeIndex(index) {
    ...
    return (0, path_1.$expressionify)({
        __kind__: reflection_1.ExpressionKind.Operator,
        __element__: this.__element__.__kind__ === reflection_1.TypeKind.array
            ? this.__element__.__element__
            : this.__element__,
        __cardinality__: reflection_1.cardinalityUtil.multiplyCardinalities(this.__cardinality__, indexTypeSet.__cardinality__),
        __name__: "[]",
        __opkind__: "Infix",
...
function arrayLikeSlice(start, end) {
    ...
    return (0, path_1.$expressionify)({
        ...
        __cardinality__: reflection_1.cardinalityUtil.multiplyCardinalities(reflection_1.cardinalityUtil.multiplyCardinalities(this.__cardinality__, (_a = startTypeSet === null || startTypeSet === void 0 ? void 0 : startTypeSet.__cardinality__) !== null && _a !== void 0 ? _a : reflection_1.Cardinality.One), (_b = endTypeSet === null || endTypeSet === void 0 ? void 0 : endTypeSet.__cardinality__) !== null && _b !== void 0 ? _b : reflection_1.Cardinality.One),
        __name__: "[]",
        __opkind__: "Infix",
...
function $arrayLikeIndexify(_expr) {
    if (_expr.__element__.__kind__ === reflection_1.TypeKind.array ||
        (_expr.__element__.__kind__ === reflection_1.TypeKind.scalar &&
...
const tupleProxyHandlers = {
    get(target, prop, proxy) {
        ...
        const items = type.__kind__ === reflection_1.TypeKind.tuple
            ? type.__items__
            : type.__kind__ === reflection_1.TypeKind.namedtuple
                ? type.__shape__
                : null;
...
function $tuplePathify(expr) {
    if (expr.__element__.__kind__ !== reflection_1.TypeKind.tuple &&
        expr.__element__.__kind__ !== reflection_1.TypeKind.namedtuple) {
        return expr;
    }
...
function tuplePath(parent, itemType, index) {
    return (0, path_1.$expressionify)({
        __kind__: reflection_1.ExpressionKind.TuplePath,
...
const typeKinds = new Set(Object.values(reflection_1.TypeKind));
